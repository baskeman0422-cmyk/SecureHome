...
const Comparison: React.FC = () => {
  ...
  return (
    <>
    <section className="pt-8 pb-24 bg-white" ref={elementRef}>
      {/* Increased max-width to allow image to grow */}
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className={`relative z-20 text-center mb-6 md:mb-[-3.5rem] transition-all duration-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
             <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-gray-900 leading-snug drop-shadow-sm px-2" style={{ textWrap: 'balance' }}>
                ...
                <span className="inline-block relative mx-2">
                    ...
                    <span className="text-red-600 text-4xl md:text-5xl">60万円</span>
                </span>
        ...
        <div className="relative z-10 bg-gray-50 rounded-t-3xl rounded-b-[3rem] p-6 md:p-12 pt-8 md:pt-24 overflow-visible shadow-inner pb-24 border-t border-gray-200 max-w-4xl mx-auto">
            ...
            <div className="relative flex flex-row gap-4 md:gap-16 items-end justify-center h-auto min-h-[400px]">
                ...
                {/* Reference Line (Dashed) - Indicates the Fair Price Level */}
                ...
                {/* High Price Bar (Stacked) - Darker "Bad" Colors */}
                <div className="flex-1 max-w-[180px] flex flex-col items-center group relative z-10">
                    ...
                    <div className="relative w-full h-72 md:h-96 flex items-end justify-center">
                        ...
                        style={{ height: '100%' }}
                        >
                            {/* Top Half: Commission - Dark Gray/Blackish with warning stripes */}
                        ...
                        {/* Total Price Bubble - Floating above - HUGE & YELLOW */}
                        <div className={`absolute -top-14 left-1/2 transform -translate-x-1/2 w-[140%] z-20 flex flex-col items-center justify-center transition-opacity duration-500 delay-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                             <div className="relative bg-white border-4 border-gray-800 text-gray-900 px-4 py-2 rounded-full shadow-xl mb-1 flex items-baseline justify-center">
                                ...
                                <span className="text-4xl md:text-6xl font-black tracking-tighter">120</span>
                ...
                {/* Arrow pointing from left to right bar bottom */}
                ...
                <div className="flex-1 max-w-[180px] flex flex-col items-center group relative z-10">
                    ...
                    <div className="relative w-full h-36 md:h-48 flex items-end justify-center">
                        {/* Bar Color changed to Red to match theme (Green removed) */}
                        <div 
                        ...
                        <div className={`absolute -top-14 left-1/2 transform -translate-x-1/2 z-20 transition-all duration-500 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                         ...
                         {/* Price Bubble - Floating above (aligned with left) - HUGE, NO YELLOW SHAPE */}
        ...
        <div className={`relative z-20 -mt-20 px-4 transition-all duration-1000 delay-500 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            {/* Container: Changed max-width to larger, modified grid for image dominance */}
            <div className="bg-white rounded-3xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.15)] p-6 md:p-8 relative overflow-hidden group border border-gray-100 max-w-6xl mx-auto">
                {/* Neutral/Warm Blobs */}
                ...
                {/* Changed Flex to Grid on MD+ to control ratio precisely */}
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    ...
                    <div className="w-full md:w-1/3 text-center md:text-left space-y-6">
                        ...
                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 leading-snug">
                    ...
                    {/* Image Side: 2/3 Width for "2x Size" effect */}
                    <div className="w-full md:w-2/3 perspective-[1000px]">
                        <div 
